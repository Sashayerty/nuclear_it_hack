...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 6), facecolor=nord6)
...
bars2 = ax2.bar(models, vram, color=colors_vram, edgecolor=nord6, linewidth=1)
...
fig.suptitle('Архитектурный выбор LLM: Почему мы используем легковесную модель',
             fontsize=16, fontweight='bold', y=1.05, color=nord0)
...
plt.savefig('llm_comparison_nord.png', dpi=600, bbox_inches='tight', facecolor=fig.get_facecolor())
