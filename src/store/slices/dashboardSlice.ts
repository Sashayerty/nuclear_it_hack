...
import { loginAdminThunk, loginOrgThunk } from './authSlice'
...
const initialRole = localStorage.getItem('user_role')

const initialState: DashboardState = {
  dashboard: null,
  currentReport: null,
  activeTab: initialRole === 'admin' ? 'admin' : 'dashboard',
  isLoading: false,
...
const dashboardSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(loginAdminThunk.fulfilled, (state) => {
        state.activeTab = 'admin'
      })
      .addCase(loginOrgThunk.fulfilled, (state) => {
