    ...
    return (
      <div className="flex items-center justify-center py-16">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-sm font-medium text-slate-500">╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╨┤╨░╨╜╨╜╤Л╤Е ╨░╨╜╨░╨╗╨╕╤В╨╕╨║╨╕...</span>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6 pb-6 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg p-6 border border-slate-100 shadow-sm space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <h3 className="text-sm font-semibold text-slate-900">╨а╨░╤Б╨┐╤А╨╡╨┤╨╡╨╗╨╡╨╜╨╕╨╡ ╨┐╤А╨╛╨╝╨┐╤В╨╛╨▓ ╨┐╨╛ ╨║╨░╤В╨╡╨│╨╛╤А╨╕╤П╨╝</h3>
                ...
                return (
                  <div key={cat.name} className="space-y-1.5">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="text-slate-500 font-semibold">{cat.requests} ╨╖╨░╨┐. ({cat.percentage}%)</span>
                    </div>
          ...
          <div className="bg-white rounded-lg p-6 border border-slate-100 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-slate-900">╨в╨╛╨┐ ╤Б╤Ж╨╡╨╜╨░╤А╨╕╨╡╨▓ ╨╕╤Б╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╨╜╨╕╤П (Use Cases)</h3>
              <span className="text-xs text-slate-400">╨Я╨╛ ╤З╨░╤Б╤В╨╛╤В╨╡ ╨╖╨░╨┐╤А╨╛╤Б╨╛╨▓</span>
            </div>
              ...
              <table className="w-full text-left text-xs">
                <thead>
                  <tr className="text-slate-400 font-medium border-b border-slate-100 pb-2">
                    <th className="pb-3 font-medium">╨б╤Ж╨╡╨╜╨░╤А╨╕╨╣ ╨╕╤Б╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╨╜╨╕╤П</th>
                    <th className="pb-3 font-medium text-right">╨Ч╨░╨┐╤А╨╛╤Б╨╛╨▓</th>
                    <th className="pb-3 font-medium text-right">╨Ф╨╛╨╗╤П</th>
                  </tr>
                </thead>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg p-6 border border-slate-100 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-slate-900">╨Ю╤Б╨╜╨╛╨▓╨╜╤Л╨╡ ╨┐╤А╨╛╨▒╨╗╨╡╨╝╤Л ╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╨╡╨╣</h3>
              <span className="text-xs px-2 py-0.5 rounded bg-rose-50 text-rose-600 font-medium">╨Ъ╤А╨╕╤В╨╕╤З╨╜╨╛</span>
            </div>
          ...
          <div className="bg-white rounded-lg p-6 border border-slate-100 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-slate-900">╨Я╨╛╤В╨╡╨╜╤Ж╨╕╨░╨╗ ╨░╨▓╤В╨╛╨╝╨░╤В╨╕╨╖╨░╤Ж╨╕╨╕</h3>
              <span className="text-xs px-2 py-0.5 rounded bg-emerald-50 text-emerald-600 font-medium">╨а╨╡╨║╨╛╨╝╨╡╨╜╨┤╨░╤Ж╨╕╨╕</span>
            </div>
              ...
              {automationCandidates.map((ac, i) => (
                <div key={i} className="p-3 rounded-md bg-blue-50/50 border border-blue-100 space-y-2">
                  ...
                  <div className="text-[11px] text-slate-500">
                    ╨Ч╨░╨┐╤А╨╛╤Б╨╛╨▓: <strong className="text-slate-800">{ac.requests}</strong>
                  </div>
                  {ac.suggested_actions && ac.suggested_actions.length > 0 && (
                    <div className="pt-1 border-t border-blue-100/60">
                      <div className="text-[10px] font-medium text-slate-400 uppercase tracking-wider mb-1">╨Ф╨╡╨╣╤Б╤В╨▓╨╕╨╡:</div>
